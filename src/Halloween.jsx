...
Command: npx gltfjsx@6.2.14 halloween.gltf 
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/halloween.gltf')
  return (
    <group {...props} dispose={null}>
      <group scale={0.01}>
        <mesh geometry={nodes.Ground_M_Ground_0.geometry} material={materials.M_Ground} position={[0, -1.785, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
...
useGLTF.preload('/halloween.gltf')
